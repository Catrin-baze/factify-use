...
if news_class == '案例一':
 ...
 st.image(image1, caption=None, width=300, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
 st.markdown(' **text** ：West Bengal: Trinamool Congress MP Abhishek Banerjee holds roadshow in Sonarpur, South Kolkata.')
 st.subheader('参考证据')
 image2 = Image.open('image/doc4.jpg')
 st.image(image2, caption=None, width=300, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
 st.markdown(' **text** ：Kolkata With West Bengal registering an alarming spike in the daily count of Covid19 cases, chief minister Mamata Banerjee urged the Election Commission of India on Thursday to hold the remaining phases of the state assembly elections in one go. On Friday, the states chief electoral officer will meet representatives of all the 10 recognised political parties in the state to ensure that Covid 19 protocols are followed during election campaigns. Amid an ongoing pandemic, we firmly opposed ‪ECISVEEPs decision to conduct WB polls in 8 phases. Now, in view of the huge surge in COVID19 cases, I urge the ECI to consider holding the remaining phases in ONE go. This will protect the people from further exposure to COVID19, Banerjee tweeted on Thursday evening. On Wednesday, the Calcutta high court ordered the state s chief election officer and all district magistrates to ensure strict implementation of coronavirus related protocols in political campaigns for the remaining four phases of polling. Four phases have been completed while the fifth phase is scheduled on Saturday. The ECI can hold the remaining three phases in one go. After the fifth phase ends around 114 seats will remain. They can give us some time for campaigning and conduct the polls in one phase around April 26, Banerjee said in an interview to a vernacular media channel on Thursday evening. A senior official of the poll panel has said that there are no plans at present to hold the remaining phases in one go. West Bengal reported 6769 new cases on Thursday, which was more than 31 times the daily count on February 26, when the ECI had announced the poll dates. This is also the highest daily count of Covid19 the state has registered since the disease broke out in 2020. The election is being conducted by the ECI. Every political party has to have deep faith in the poll panel’s ability and neutrality, said Jay Prakash Majumdar, vice-president of the BJP’s state unit. While a Congress candidate from Murshidabad district, who was Covid positive, died on Thursday, at least five other candidates of various political parties have been diagnosed with the virus.)
